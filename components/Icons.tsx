...
export const Icons = {
    ...
    Turtle: createIcon(<><path d="m15.5 16-3 3-3-3"></path><path d="M17 21h-状況a2 2 0 0 1-2-2v-2h8v2a2 2 0 0 1-2 2Z"></path><path d="M18 17a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2h8Z"></path><path d="M8 17H5a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1l2 3 2-3h1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-3"></path><path d="M12 7V5l-1-1-1 1v2"></path></>),
